...
const Card = (props) => {
  ...
  const senderDetails = ["senderName","receiverName", "receiverPhoneNo"];
  ...
  return (
    <>
      ...
      >
        ...
        {props.role === "admin" ? (
          <ReusableForm item={props.item} isAdminEdit={true} />
        ) : (
          <CustomForm
            endpoint="orders"
            basePrice={props.item.minimumDeliveryPrice}
      ...
      <div
        onClick={() => (props.role === "admin" ? null : setIsModalOpen(true))}
        className="category"
      >
